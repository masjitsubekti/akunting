...
function pageLoad(page = 1) {
	...
	$.ajax({
		url: site_url + "/Jenis_barang/fetch_data",
		type: "GET",
		dataType: "html",
		data: {
			page: page,
...
$("#btn-create").on("click", function () {
	$.ajax({
		url: site_url + "/Jenis_barang/load_modal",
		type: "POST",
		data: {},
		dataType: "html",
		beforeSend: function () {},
...
$(document).on("click", ".btn-edit", function (event) {
	...
	$.ajax({
		...
		success: function (result) {
			$("#div_modal").html(result);
			$("#modeform").val("UPDATE");
			$("#modal-title").text("Edit Jenis Barang");
			$("#form-modal").modal("show");
		},
	});
});
...
$(document).on("click", ".btn-delete", function (e) {
	...
	Swal.fire({
		...
		text: "Apakah Anda yakin menghapus jenis barang : "+ title +" ?",
		icon: "warning",
		...
		preConfirm: function () {
			return new Promise(function (resolve) {
				$.ajax({
					method: "GET",
					dataType: "json",
					url: site_url + "/Jenis_barang/delete/" + id,
					data: {},
...
$(document).on("submit", "#formdata", function (event) {
	...
	$.ajax({
		url: site_url + "/Jenis_barang/save",
		method: "POST",
		dataType: "json",

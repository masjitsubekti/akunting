...
function pageLoad(page = 1) {
	...
	$.ajax({
		url: site_url + "/Satuan/fetch_data",
		type: "GET",
		dataType: "html",
		data: {
			page: page,
...
$("#btn-create").on("click", function () {
	$.ajax({
		url: site_url + "/Satuan/load_modal",
		type: "POST",
		data: {},
		dataType: "html",
		beforeSend: function () {},
...
$(document).on("click", ".btn-delete", function (e) {
	...
	Swal.fire({
		title: "Hapus Satuan",
		text: "Apakah Anda yakin menghapus satuan : "+ title +" ?",
		icon: "warning",

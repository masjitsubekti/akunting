...
class Satuan extends CI_Controller {
  ...
  public function fetch_data(){
    ...
    $page              = array();
    $page['limit']     = $limit;
    $page['count_row'] = $this->Satuan_m->get_list_count($filter)['jml'];
    $page['current']   = $pg;
    $page['list']      = gen_paging($page);
    $data['paging']    = $page;
    $data['list']      = $this->Satuan_m->get_list_data($filter);
  ...
  public function save(){
    ...
    if($id!=""){
        ...
        $this->Satuan_m->update($data_object, array(
          'id' => $id
        )); 
        ...
        $this->Satuan_m->save($data_object);//insert untuk menambahkan data
        $response['success'] = TRUE;
  ...
  public function delete($id){
    if($id){
      ...
      $this->Satuan_m->update($object, array(
        'id' => $id
      )); 

        ...
        foreach ($list->result() as $row) { $no++; ?>
          <tr>
            ...
            <td class="text-center">
              <a href="javascript:;" data-id="<?=$row->id?>" data-name="<?=$row->nomor?>" class="btn btn-sm btn-success btn-edit" data-toggle="tooltip" title="Verifikasi"><i style="color:#fff;" class="fa fa-edit"></i></a>
            </td>
          </tr>
        <?php 
          }
